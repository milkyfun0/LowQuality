...
def parse_option():
    ...
    parser.add_argument('--root_path', default='../data/NWPU-RESISC45/original/')
    parser.add_argument('--txtfile_path', default='txtfile/')
    parser.add_argument('--save_path', default='/home/lkshpc/huangmengluan/low-quality/log/NWPU/')
...
def train(train_loader, test_loader, dataset_loader, bit, args):
    net = AlexNet(hash_bit=bit, classes=45, num_embedding=args.num_embedding, topk=args.topk).cuda()
